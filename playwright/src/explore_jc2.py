...
async def explore_jobcopilot():
    ...
    async with async_playwright() as p:
        ...
        # 访问 Applications 页面
        await page.goto('https://app.jobcopilot.com/applications', wait_until='domcontentloaded')
        ...
        structure = await page.evaluate("""
            () => {
                return {
                    ...
                    mainContent: document.querySelector('main, #app, #root, .container, body')?.innerText?.substring(0, 2000) || ''
                };
            }
        """)

        print('=== Applications Page ===')
        ...
        """)
        print('\\n=== iFrames ===')
        print(json.dumps(iframes, ensure_ascii=False, indent=2))
